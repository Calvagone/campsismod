...
For this exercise, we'll need the `campsis` package, which includes the `campsismod` package.
...
This model can now be loaded and simulated by CAMPSIS.

```{r, warning=FALSE, fig.align='center', fig.height=4, fig.width=8}
