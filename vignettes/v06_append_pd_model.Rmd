...
### Load a compartment effect model

The effect compartment model can be downloaded here and loaded as follows:

```{r echo=TRUE, warning=FALSE, message=FALSE}
pd_model <- read.campsis("resources/effect_cmt_model/")
pd_model
```
